 ...
 **************************************************************************/
void hdmi_clk_init(int mode, int width, int height)
{
    ...
    else if (mode ==  7) { //HDMI User Mode
        if( (width == 800) && (height == 480) ) {
            DISP_MOON4_REG->plltv_ctl[0] = 0xFFFF0001; 	//G4.14
            DISP_MOON4_REG->plltv_ctl[1] = 0xFFFF0084; 	//G4.15
            DISP_MOON4_REG->plltv_ctl[2] = 0xFFFF0815; 	//G4.16 33MHz
            DISP_MOON4_REG->otp_st = 0x00300000; 		//G4.31
        }
        else if( (width == 1024) && (height == 600) ) {
            DISP_MOON4_REG->plltv_ctl[0] = 0xFFFF0001; 	//G4.14
            DISP_MOON4_REG->plltv_ctl[1] = 0xFFFF0084; 	//G4.15
            DISP_MOON4_REG->plltv_ctl[2] = 0xFFFF0821; 	//G4.16 51MHz
            DISP_MOON4_REG->otp_st = 0x00300000; 		//G4.31
        }
        else {
            ;//TBD

...
void ttl_clk_init(int method, int width, int height)
{
    if (method == 0) {
		...
		if ( (width == 320) && (height == 240) ) {
			...
			//DISP_MOON4_REG->plltv_ctl[1] = 0x00000000; //G4.15
			DISP_MOON4_REG->plltv_ctl[2] = 0xFFFF0300; //en pll , clk = 6.75M //(FVCO= (27/(M+1)) * (N+1) ) M=3,N=0 //G4.16
...
int spi_init_20210401[142] = {	0x0000, 0x0110, 0x02B1, 0x0339, 0x0404, 0x0604, 0x0F60,
							0x0001, 0x0504, 0x0A10, 0x0B1A, 0x0C10, 0x0D1A, 0x0E10, 0x0F1A,
							0x0002, 0x010A, 0x0448, 0x0524, 0x06A7, 0x07A7, 0x0F08, 0x1228, 0x1308, 0x1700, 0x18D9,
							0x0008, 0x0985, 0x0B00,
							0x0003, 0x0100, 0x0207, 0x030C, 0x040F, 0x050F, 0x0612, 0x0718, 0x81E, 0x0926, 0x0A28,
								0x0B28, 0x0C1C, 0x0D14, 0x0E19, 0x0F27, 0x101A, 0x1114, 0x1224, 0x132D, 0x141E,
							0x0006, 0x0100, 0x0207, 0x030C, 0x040F, 0x050F, 0x0612, 0x0718, 0x81E, 0x0926, 0x0A28,
								0x0B28, 0x0C1C, 0x0D14, 0x0E19, 0x0F27, 0x101A, 0x1114, 0x1224, 0x132D, 0x141E,
							0x000F, 0x0301, 0x1300, 0x1520, 0x1601, 0x1A42, 0x1E80,
							0x0010, 0x0610, 0x0EC0, 0x0F00, 0x1B3C, 0x1EC0,
							0x0011, 0x0901, 0x0A10, 0x0B0F, 0x0C0E, 0x0D0D, 0x0E0C, 0x0F0B, 0x100A, 0x1109, 0x1228,
...
void ttl_spi_init(int method)
{
	...
	if (method == 0) {
		...
		for (i = 0; i < 142; i++)
			Spi_Write_16bit(spi_init_20210401[i]);
...
U_BOOT_DRIVER(sp7021_display) = {
	...
	.priv_auto	= sizeof(struct sp7021_disp_priv),
};
